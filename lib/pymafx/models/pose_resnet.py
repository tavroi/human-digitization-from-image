...
class PoseResNet(nn.Module):
    def __init__(self, block, layers, cfg, global_mode, **kwargs):
        ...
        self.extra = extra
        self.deconv_with_bias = extra.DHDFIV_WITH_BIAS
        ...
        if self.global_mode:
            ...
            self.deconv_layers = self._make_deconv_layer(
                extra.NUM_DHDFIV_LAYERS,
                extra.NUM_DHDFIV_FILTERS,
                extra.NUM_DHDFIV_KERNELS,
            )

        # self.final_layer = nn.Conv2d(
        #     in_channels=extra.NUM_DHDFIV_FILTERS[-1],
        #     out_channels=17,
    ...
    def forward(self, x):
        ...
        if self.global_mode:
            ...
            g_feat = None
            if self.extra.NUM_DHDFIV_LAYERS == 3:
                deconv_blocks = [
            ...
            s_feat_list = []
            s_feat = x
            for i in range(self.extra.NUM_DHDFIV_LAYERS):
